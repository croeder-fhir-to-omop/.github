...
This setup tests the IG against **FHIR R5** data. The tests here assume R5. matchbox calls the terminology server via R4 endpoints; both enchilada and echidna support R4 and R5.
